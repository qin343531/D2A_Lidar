...
#define CENTER_BASE_ANGLE 28.5  //���Բ����Ƕ�

#define FPS_MAX 2188    // 正常范围上限 (2088+100)
#define FPS_MIN 1988    // 正常范围下限 (2088-100)
#define FPS_CONTINUE_SECOND 5    //fps�쳣�ĳ���ʱ��

#define SPEED_MAX 420     //����ٶ�
#define SPEED_MIN 300     //��С�ٶ�
#define SPEED_CONTINUE_SECOND 5   //����ٶȻ�����С�ٶ��쳣�ĳ���ʱ��
...
void ReadParsePackage::SetReadCharsError(int errCode)
{
    ...
    case -3:
        ...
        break;
    case -1:
        m_lastErrorCode = ERR_SERIAL_READFILE_ZERO; // 修改：原错误label修改为赋值语句
        break;
    case 0:
